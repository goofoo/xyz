...
void Keyboard(unsigned char key, int, int) {
  ...
  case 'a':
    if (!s_is_rendering)
      tgir::Scene::GetInstance().Camera().MoveBy(tgir::Vector3(-0.05, 0, 0));
    break;
  case 'd':
    if (!s_is_rendering)
      tgir::Scene::GetInstance().Camera().MoveBy(tgir::Vector3(+0.05, 0, 0));
  ...
  case 's':
    if (!s_is_rendering)
      tgir::Scene::GetInstance().Camera().MoveBy(tgir::Vector3(0, -0.05, 0));
    break;
  case 'w':
    if (!s_is_rendering)
      tgir::Scene::GetInstance().Camera().MoveBy(tgir::Vector3(0, +0.05, 0));
  ...
  case 'e':
    if (!s_is_rendering)
      tgir::Scene::GetInstance().Camera().MoveBy(tgir::Vector3(0, 0, -0.05));
    break;
  case 'q':
    if (!s_is_rendering)
      tgir::Scene::GetInstance().Camera().MoveBy(tgir::Vector3(0, 0, +0.05));
  ...
  case 'j':
    if (!s_is_rendering)
      tgir::Scene::GetInstance().Camera().LookBy(tgir::Vector3(-0.05, 0, 0));
    break;
  case 'l':
    if (!s_is_rendering)
      tgir::Scene::GetInstance().Camera().LookBy(tgir::Vector3(+0.05, 0, 0));
  ...
  case 'k':
    if (!s_is_rendering)
      tgir::Scene::GetInstance().Camera().LookBy(tgir::Vector3(0, -0.05, 0));
    break;
  case 'i':
    if (!s_is_rendering)
      tgir::Scene::GetInstance().Camera().LookBy(tgir::Vector3(0, +0.05, 0));
  ...
  case 'o':
    if (!s_is_rendering)
      tgir::Scene::GetInstance().Camera().LookBy(tgir::Vector3(0, 0, -0.05));
    break;
  case 'u':
    if (!s_is_rendering)
      tgir::Scene::GetInstance().Camera().LookBy(tgir::Vector3(0, 0, +0.05));
...
interpret_result Interpret(std::tstring &command, bool const wait_shell) {
  ...
  if (_TEXT("set") == command) {
    ...
    if (_TEXT("rep") == command) {
      ...
      tgir::Vector3 eye;
      sin >> eye;
      tgir::Scene::GetInstance().Camera().MoveTo(eye);
      ...
      tgir::Vector3 at;
      sin >> at;
      tgir::Scene::GetInstance().Camera().LookAt(at);
      ...
      tgir::Scene::GetInstance().SetDimension(width, height);
  ...
  if (_TEXT("load") == command) {
    ...
    if (!!in) {
                 ...
                 << std::endl;
      {
        ...
        tgir::Scene::GetInstance().Load(
            in);  // {sponza, winosi, scene1, scene2}
  ...
  if (_TEXT("save") == command) {
    ...
    if (!!fout) {
      tgir::Scene const &scene = tgir::Scene::GetInstance();
      tgir::Vector3 const eye = scene.Camera().Eye();
      tgir::Vector3 const at = scene.Camera().At();
  ...
  if (_TEXT("ren") == command) {
    ...
    // 出力フォルダを生成
    {
      ...
      ::_stprintf_s(
          ...
          tgir::Scene::GetInstance().GetWidth(),
          tgir::Scene::GetInstance().GetHeight(), 1900 + t.tm_year,
    ...
    case 0:
      s_kicker = std::auto_ptr<hi::thread>(new tgir::BPT());
      s_outdir_path += _TEXT("BPT/");
      break;
    case 1:
      s_kicker = std::auto_ptr<hi::thread>(new tgir::SimplifiedMLT());
      s_outdir_path += _TEXT("SimplifiedMLT/");
      break;
    case 2:
      s_kicker = std::auto_ptr<hi::thread>(new tgir::FullMLT());
      s_outdir_path += _TEXT("FullMLT/");
      break;
    case 3:
      s_kicker = std::auto_ptr<hi::thread>(new tgir::FullRELT());
      s_outdir_path += _TEXT("FullRELT/");
      break;
    // case  2: s_kicker = std::auto_ptr<hi::thread>(new tgir::RELT());
    // s_outdir_path += _TEXT("RELT/"); break;
    // case  3: s_kicker = std::auto_ptr<hi::thread>(new tgir::OriginalMLT());
    // s_outdir_path += _TEXT("OriginalMLT/"); break;
    // case  3: s_kicker = std::auto_ptr<hi::thread>(new tgir::Palt());
    // s_outdir_path += _TEXT("Palt/"); break;
    case -1:
      s_kicker = std::auto_ptr<hi::thread>(new tgir::Ptrr());
      s_outdir_path += _TEXT("Ptrr/");
      break;
    // case -2: s_kicker = std::auto_ptr<hi::thread>(new tgir::Ptgw());
    // s_outdir_path += _TEXT("Ptgw/"); break;
    case -3:
      s_kicker = std::auto_ptr<hi::thread>(new tgir::Ptpf1());
      s_outdir_path += _TEXT("Ptpf1/");
      break;
    case -4:
      s_kicker = std::auto_ptr<hi::thread>(new tgir::Ptpf2());
      s_outdir_path += _TEXT("Ptpf2/");
      break;

#ifndef HI_REMOVE_PHOTON_MAPS
    case -5:
      s_kicker = std::auto_ptr<hi::thread>(new tgir::Dvpm());
      break;
    case -6:
      s_kicker = std::auto_ptr<hi::thread>(new tgir::Dvim());
      break;
    case -7:
      s_kicker = std::auto_ptr<hi::thread>(new tgir::Dvpf());
      break;
#endif
    default:
      return SHELL_CONTINUE;
...
int Shell(std::tistream &in, bool const gui) {
  ...
  for (;;) {
    ...
    switch (tgir::Interpret(line, !gui)) {
