...
namespace tgir {
bool Film::SaveAsHdr(std::tchar_t const *filename, tgir::Real const mpp) const {
  ...
  std::size_t const width = GetWidth();
  std::size_t const height = GetHeight();
